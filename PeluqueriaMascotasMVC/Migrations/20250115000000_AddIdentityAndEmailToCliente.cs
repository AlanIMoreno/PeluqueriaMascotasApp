...
{
    /// <inheritdoc />
    public partial class AddIdentityAndEmailToCliente : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Agregar columna Email a Personas (si no existe)
            ...
            // Agregar columna IdentityUserId a Clientes (en la tabla Personas porque usamos TPH)
            migrationBuilder.AddColumn<string>(
                name: "IdentityUserId",
                table: "Personas",
                type: "nvarchar(450)",
            ...
            // Crear tabla AspNetRoles (Identity)
        ...
        {
            // Eliminar tablas de Identity (en orden inverso de creación)
